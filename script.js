// --- MENU DATABASE ARRAY - MATCHED DIRECTLY TO YOUR GITHUB ROOT FILES ---
const menuItems = [
    ...
    {cat:"dinner", img:"Pan of catfish.jpeg", title:"Chicken Strip Dinner", desc:"Golden fried chicken strips with your choice of two signature sides and cornbread.", price:"$20.00"},
    ...
    // --- DRINKS ($3.00 / $5.00) ---
    {cat:"drinks", img:"Pan of catfish.jpeg", title:"Strawberry Lemonade", desc:"Freshly squeezed lemonade blended thoroughly with sweet pureed strawberries.", price:"$5.00"},
    {cat:"drinks", img:"Pan of catfish.jpeg", title:"Classic Lemonade / Kool-Aid", desc:"Nostalgic refreshing beverages, sweetened just right.", price:"$3.00"},
    {cat:"drinks", img:"Pan of catfish.jpeg", title:"Bottled Water", desc:"Pure and essential hydration.", price:"$1.00"},
